...
typedef struct _xen_WrapperMessage {
    bool has_channelConfig;
    xen_ChannelConfig channelConfig;
/* @@protoc_insertion_point(struct:xen_WrapperMessage) */
} xen_WrapperMessage;
...
#define xen_WrapperMessage_init_default          {false, xen_ChannelConfig_init_default}
...
#define xen_WrapperMessage_init_zero             {false, xen_ChannelConfig_init_zero}
