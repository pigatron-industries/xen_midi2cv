...
typedef struct _xen_ControllerMapping {
    int8_t midiChannel;
    int8_t midiControllerCoarse;
    int8_t midiControllerFine;
    int8_t cvChannel;
    int8_t cvBank;
...
#define xen_ControllerMapping_init_default       {0, 0, 0, 0, 0}
...
#define xen_ControllerMapping_init_zero          {0, 0, 0, 0, 0}
...
#define xen_ControllerMapping_midiControllerCoarse_tag 2
#define xen_ControllerMapping_midiControllerFine_tag 3
