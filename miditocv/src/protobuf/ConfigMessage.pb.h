...
typedef struct _xen_ControllerConfig {
    ...
    xen_ControllerMapping controllerMapping[24];
...
#define xen_ControllerConfig_init_default        {0, {xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default, xen_ControllerMapping_init_default}}
...
#define xen_ControllerConfig_init_zero           {0, {xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero, xen_ControllerMapping_init_zero}}
...
#define xen_ConfigWrapper_size                   2138
#define xen_ChannelConfig_size                   560
#define xen_ChannelMapping_size                  33
#define xen_ControllerConfig_size                840
